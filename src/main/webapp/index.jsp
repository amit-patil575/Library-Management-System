	...
	<div id="page" class="site" itemscope itemtype="http://schema.org/LocalBusiness">
		<header class="site-header">
				...
				<div class="container">
					<div class="top-header-left">
						<div class="top-header-block">
							<a href="https://sageuniversity.in/" itemprop="email"><i class="fas fa-envelope"></i> www.Sageuniversity.com</a>
						</div>
						<div class="top-header-block">
							<a href="tel:+91 1800 100 7031" itemprop="telephone"><i class="fas fa-phone"></i>+91 1800 100 7031</a>
						</div>
					</div>
			...
			<div class="main-header">
				<div class="container">
					<div >
						<img src="images/Sage.jpeg" width="100" alt="Logo Image">
						<!-- <h1>Education</h1> -->
					</div>
					<div class="nav-wrap">
						<nav class="nav-desktop">
							<ul class="menu-list">
							   ...
							   <button class="button-33"><li><a href="#">Home</a></li></button>
							   <button class="button-33"><li><a href="#">About</a></li></button>
								<button class="button-33"><li><a href="#">ContactUs</a></li></button>
								<button class="button-33"><li><a href="login.html">Login</a></li></button>
							</ul>
						</nav>
						<div id="bar">
		...
		<div class="banner">
			<div class="owl-four owl-carousel" itemprop="image">
				<img src="images/SageBaner.jpg" alt="Image of Bannner">
				<img src="images/Sage1.jpeg" alt="Image of Bannner">
			</div>
					...
					<div class="owl-one owl-carousel">
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap" itemprop="image"><img src="images/course-pic.jpg" alt="courses picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Learn Data Analysts >>></a>
							<div class="box-body" itemprop="description">
								<p>Data analysts are in high demand across various industries, from finance and healthcare to marketing and education.</p>
								<section itemprop="time">
									<p><span>Duration:</span> 4 Years</p>
									<p><span>Class Time:</span> 6am-12am / 11am-5pm</p>
									<p><span>Fee:</span> 90,000</p>
								</section>
							</div>
						</div>
						...
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							...
							<div class="box-body" itemprop="description">
								<p>Web design is a creative field that requires a good understanding of both design principles and user behavior.</p>
								<section itemprop="time">
									<p><span>Duration:</span> 4 Years</p>
									<p><span>Class Time:</span> 6am-12am / 11am-5pm</p>
									<p><span>Fee:</span> 90,000</p>
						...
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							...
							<div class="box-body" itemprop="description">
								<p>A DBMS, or Database Management System, is essentially a software organizer for your data,
								  DBMS is most important for web development.</p>
								<section itemprop="time">
									<p><span>Duration:</span> 4 Years</p>
									<p><span>Class Time:</span> 6am-12am / 11am-5pm</p>
									<p><span>Fee:</span> 90,000</p>
						...
						<div class="box-wrap" itemprop="event" itemscope itemtype=" http://schema.org/Course">
							<div class="img-wrap"  itemprop="image"><img src="images/course-pic.jpg" alt="courses picture"></div>
								<a href="#" class="learn-desining-banner" itemprop="name">Learn Data Structure >>></a>
							<div class="box-body" itemprop="description">
								<p>In computer science, a data structure is the
								 foundation for organizing, processing, and storing data
								  efficiently.
                                </p>
								<section itemprop="time">
									<p><span>Duration:</span> 4 Years</p>
		...
		<section class="whyUs-section">
			<div class="container">
				...
				<div class="whyus-wrap">
					<h1>why us?</h1>
					<p itemprop="description">Career Skills & Knowledge: College equips you with specialized skills and knowledge for your desired career path.
</br>Earning Potential: Studies show college graduates often earn more over their lifetime.
</br>Personal Growth: College fosters intellectual curiosity, critical thinking, and prepares you for a fulfilling career.
						...
						<div class="border">
							...
							<div class="customer-review">
								<p itemprop="description">
									"Web design is a creative field that requires a good 
									understanding of both design principles and user behavior."
								</p>
							</div>
						</div>
					</div>
